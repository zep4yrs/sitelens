...
**方式一：图形安装（推荐）** —— 从 [Releases](../../releases) 下载 `SiteLens-2.0.0-preview-setup-full.exe`，向导安装，完成即启动。
...
<div align="center">
  <img src="assets/roadmap.png" width="100%" alt="SiteLens 产品远景路线图：看见风险 · 证明风险 · 理解风险 · 持续学习">
</div>
...
| 时代 | 版本 | 主题 | 一句话 |
|---|---|---|---|
| 第一时代 | 1.0 → 3.0 | **看见与证明** | 让未知风险变得可见、可证、可复现 |
| 第二时代 | 4.0 → 5.0 | **理解与推理** | 理解风险之间的关系，学习如何判断风险 |
| 第三时代 | 6.0 → 未来 | **持续与进化** | 从一个安全工具，进化成持续学习的安全系统 |

| 版本 | 定位 | 核心问题 | 关键能力 |
|---|---|---|---|
| **1.0 发现器**（已发布） | DISCOVERY | 站点有什么？ | 指纹识别 · 资产发现 · 接口/目录扫描 · 安全情报关联 · 七种扫描模式 |
| **2.0 验证器**（预览） | VERIFICATION | 这个问题是真的吗？ | 证据链（请求/响应/命中）· 盲注/出带验证 · 认证态复用 · 可复现报告 |
| **3.0 影响验证器** | IMPACT VALIDATION | 能证明到什么程度？ | 漏洞利用验证 · 影响范围分析 · 数据泄露验证 · 回显/访问验证 |
| **4.0 攻击链分析** | ATTACK CHAIN | 这些风险之间有什么关系？ | 多源关联分析 · 攻击路径推导 · 资产关系图谱 · AST 数据流分析 · CWE 全集 |
| **5.0 安全推理器** | ML REASONING | 哪些风险最值得关注？为什么？ | 机器学习风险排序 · 安全知识图谱 · 关联关系推理 · 风险预测与解释 · 验证策略推荐 |
| **6.0 持续安全平台** | CONTINUOUS SECURITY | 风险正在如何变化？ | 资产/代码/配置变化监测 · 自动化重新评估 · 风险趋势分析 · 持续验证与回归测试 · 安全运营集成 |
| **7.0 安全知识系统** | SECURITY INTELLIGENCE | SiteLens 知道多少？ | 安全知识图谱构建 · 历史数据沉淀 · 行业威胁情报融合 · 智能分析与问答 · 领域知识学习 |
| **Beyond 8.0+ 自进化安全平台** | SELF-EVOLVING | 能否持续学习和进化？ | 自学习安全模型 · 主动风险发现 · 自动化策略调整 · 全生命周期防护 · 生态联动与协同 |
